...
const steps: Step[] = [
  ...
  },
  {
    ...
    note: "OpenPress uses npm script aliases in package.json, so `npm run build` maps to the Vite build command. Cloudflare Pages will automatically install dependencies (via the lockfile) and run the build. You don't need a separate deploy command — Pages handles deployment automatically after building.",
  },
  {
    id: 6,
